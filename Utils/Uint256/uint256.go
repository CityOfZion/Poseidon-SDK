// Taken from anthdm, code modified to integrate with current infrastructure. No logic was changed: https://github.com/CityOfZion/neo-go/blob/master/pkg/util/uint256.go
package util
...
func (u Uint256) BytesReverse() []byte {
	return sliceUtils.Reverse(u.Bytes())
}
...
func (u Uint256) String() string {
	return hex.EncodeToString(sliceUtils.Reverse(u.Bytes()))
}
